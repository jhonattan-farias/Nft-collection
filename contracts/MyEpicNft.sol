...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string[] firstWords = ["Sova", "Jett", "Raze", "Fade", "Viper", "Astra"];
  string[] secondWords = ["Game", "Discord", "Deutschland", "Espana", "Brasil", "USA"];
  string[] thirdWords = ["North", "South", "Center", "Eurasia", "Asia", "africa"];
